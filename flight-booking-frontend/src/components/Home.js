...
export class Home extends Component {
  ...
  render() {
    ...
    return (
      <div className="row" style={{ height:'100vh',margin:"-105",width:'100%',display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',backgroundImage: "url(" + "https://www.worldatlas.com/r/w960-q80/upload/44/cd/6d/shutterstock-311421530.jpg" + ")",
      backgroundPosition: 'center',
      backgroundSize: 'cover',
      backgroundRepeat: 'no-repeat'
    }}>
        <div className="col" style={{ marginLeft: "2rem" }}>
          <Breadcrumb style={{ marginRight: "2rem" ,fontSize: "50px",fontColor: "red"}}>
