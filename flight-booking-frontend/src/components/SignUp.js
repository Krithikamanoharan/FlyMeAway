...
//import background from "flight-booking-frontend\src\components\Airplane-In-Flight-Wallpaper.jpg";
  ...
  render() {
    ...
    return (
      ...
      backgroundRepeat: 'no-repeat'
        ...
        <div className="col" style={{opacity: .9,padding:170,height:'90vh'}}>
